		...
		( 
			{getUnorderedGroupHelper().canSelect(grammarAccess.getCloneDetectionAccess().getUnorderedGroup(), 5)}?=>(
				...
				(
					...
					(
						{ before(grammarAccess.getCloneDetectionAccess().getPathsAssignment_5()); }
						((rule__CloneDetection__PathsAssignment_5)=>rule__CloneDetection__PathsAssignment_5)*
						{ after(grammarAccess.getCloneDetectionAccess().getPathsAssignment_5()); }
					)
				)
			)
		...
		( 
			{getUnorderedGroupHelper().canSelect(grammarAccess.getCloneDetectionAccess().getUnorderedGroup(), 6)}?=>(
				...
				(
					...
					(
						{ before(grammarAccess.getCloneDetectionAccess().getNotCompareAssignment_6()); }
						((rule__CloneDetection__NotCompareAssignment_6)=>rule__CloneDetection__NotCompareAssignment_6)*
						{ after(grammarAccess.getCloneDetectionAccess().getNotCompareAssignment_6()); }
					)
				)
			)
		...
		( 
			{getUnorderedGroupHelper().canSelect(grammarAccess.getCloneDetectionAccess().getUnorderedGroup(), 7)}?=>(
				...
				(
					...
					(
						{ before(grammarAccess.getCloneDetectionAccess().getCompareAssignment_7()); }
						((rule__CloneDetection__CompareAssignment_7)=>rule__CloneDetection__CompareAssignment_7)*
						{ after(grammarAccess.getCloneDetectionAccess().getCompareAssignment_7()); }
					)
				)
			)
