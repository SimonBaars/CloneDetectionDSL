...
public class CloneDetectionDSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CloneDetectionDSLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getLibraryPathAccess().getGroup(), "rule__LibraryPath__Group__0");
			...
			builder.put(grammarAccess.getCloneDetectionAccess().getPathsAssignment_5(), "rule__CloneDetection__PathsAssignment_5");
			builder.put(grammarAccess.getCloneDetectionAccess().getNotCompareAssignment_6(), "rule__CloneDetection__NotCompareAssignment_6");
			builder.put(grammarAccess.getCloneDetectionAccess().getCompareAssignment_7(), "rule__CloneDetection__CompareAssignment_7");
			builder.put(grammarAccess.getProjectAccess().getPathAssignment_1(), "rule__Project__PathAssignment_1");
			builder.put(grammarAccess.getLibraryPathAccess().getPathAssignment_1(), "rule__LibraryPath__PathAssignment_1");
