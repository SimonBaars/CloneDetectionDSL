 ...
 * </p>
 * <ul>
 *   <li>{@link com.simonbaars.cdd.cloneDetectionDSL.impl.ExpressionBracketImpl#getSub <em>Sub</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionBracketImpl extends IntExpressionImpl implements ExpressionBracket
{
  ...
  {
    return CloneDetectionDSLPackage.Literals.EXPRESSION_BRACKET;
  }
  ...
  public NotificationChain basicSetSub(IntExpression newSub, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CloneDetectionDSLPackage.EXPRESSION_BRACKET__SUB, oldSub, newSub);
  ...
  public void setSub(IntExpression newSub)
  {
    if (newSub != sub)
    {
      ...
      if (sub != null)
        msgs = ((InternalEObject)sub).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CloneDetectionDSLPackage.EXPRESSION_BRACKET__SUB, null, msgs);
      if (newSub != null)
        msgs = ((InternalEObject)newSub).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CloneDetectionDSLPackage.EXPRESSION_BRACKET__SUB, null, msgs);
      msgs = basicSetSub(newSub, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CloneDetectionDSLPackage.EXPRESSION_BRACKET__SUB, newSub, newSub));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CloneDetectionDSLPackage.EXPRESSION_BRACKET__SUB:
