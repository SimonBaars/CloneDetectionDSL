...
public class CloneDetectionDSLPackageImpl extends EPackageImpl implements CloneDetectionDSLPackage
{
   ...
   * @generated
   */
  private EClass libraryPathEClass = null;
  ...
  public void createPackageContents()
  {
    ...
    createEReference(cloneDetectionEClass, CLONE_DETECTION__PATHS);
    ...
    libraryPathEClass = createEClass(LIBRARY_PATH);
    createEAttribute(libraryPathEClass, LIBRARY_PATH__PATH);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getCloneDetection_Paths(), this.getLibraryPath(), null, "paths", null, 0, -1, CloneDetection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(libraryPathEClass, LibraryPath.class, "LibraryPath", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getLibraryPath_Path(), ecorePackage.getEString(), "path", null, 0, 1, LibraryPath.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
