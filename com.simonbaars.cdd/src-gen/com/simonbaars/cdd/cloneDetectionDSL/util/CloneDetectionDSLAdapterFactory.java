...
public class CloneDetectionDSLAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected CloneDetectionDSLSwitch<Adapter> modelSwitch =
    new CloneDetectionDSLSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseLibraryPath(LibraryPath object)
      {
        return createLibraryPathAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.simonbaars.cdd.cloneDetectionDSL.LibraryPath <em>Library Path</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createLibraryPathAdapter()
  {
    return null;
  }
